...
import com.example.wanandroidapp.databinding.KeActivityMainBinding

class KeMainActivity : BaseBindingActivity<KeActivityMainBinding>(KeActivityMainBinding::inflate) {
