package com.example.library_network.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.example.library_base.utils.LogUtil
import com.example.library_network.callback.IApiErrorCallback
...
open class BaseViewModel : ViewModel() {
     ...
     */
    fun launchUI(responseBlock: suspend () -> Unit, errorBlock: (Int?, String?) -> Unit) {
